...
//       <h1 className="text-5xl font-medium text-center">Wide Reach Close Connection</h1>
//       <p className="text-xl text-light_black opacity-75 text-center mt-6">The complete support kit to turn one-time browsers into long-term customers.</p>
//       <Carousel indicators={true}>
//         <Carousel.Item>
//           <div className="card">
//             <img src={img1} className="card-img-top" alt="Card 1" />
//             <div className="card-body">
//               <h1 className="text-2xl text-grn font-bold">Conversational support</h1>
//               <p className="card-text">
//                 Strike up meaningful conversations with personalized chat tools, from Instagram & WhatsApp to live chat.
//               </p>
//             </div>
//           </div>
//         </Carousel.Item>
...
//             <div className="card-body">
//               <h1 className="text-2xl text-grn font-bold">Marketing Support</h1>
//               <p className="card-text">
//                 Enable interactive, personalized two-way messaging for customer support and engagement.
//               </p>
//             </div>
//           </div>
//         </Carousel.Item>
...
//             <div className="card-body">
//               <h1 className="text-2xl text-grn font-bold">Analytical Support</h1>
//               <p className="card-text">
//                 Measure WhatsApp communication effectiveness with analytics, gaining insights into customer interactions & engagement metrics.
//               </p>
//             </div>
//           </div>
//         </Carousel.Item>
